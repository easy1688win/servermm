...
router.get('/list-context', requirePermission('route:players'), getPlayerListContext);
...
router.get('/:id/referrals', requirePermission('route:players'), getPlayerReferralStats);
